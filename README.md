...
[![DOI](https://zenodo.org/badge/1085167039.svg)](https://doi.org/10.5281/zenodo.20383982)
...
*Plot.py* reads the Par.npy and Numerical_Data.npy files to produce the different plot presented in Figure 1 of the main text.
